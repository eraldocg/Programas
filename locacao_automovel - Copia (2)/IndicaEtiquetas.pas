    ...
    try
      ...
      begin
        ...
        BancodeDados.Clientes.SQL.Text := PrincipalForm.SQLrepositorio(1) +
          ' and c.cli_id in (' + BancodeDados.PegarAtivo(listaCli) + ')';
        BancodeDados.Clientes.Open;
        BancodeDados.Clientes.First;
        while not BancodeDados.Clientes.Eof do
        begin
          if (length(BancodeDados.ClientesLOGRADOURO.Value + ' - ' +
            BancodeDados.ClientesBAIRRO.Value) <= 55) then
            quebra := #13
          else
            quebra := ' - ';
          ...
          begin
            ...
            RelEtiquetasForm.TempNOME.AsString :=
              BancodeDados.ClientesNOME.Value;
            RelEtiquetasForm.TempEND.AsString :=
              BancodeDados.ClientesLOGRADOURO.Value + ' - ' +
              BancodeDados.ClientesBAIRRO.Value + quebra +
            ...
            RelEtiquetasForm.TempCEP.AsString := 'CEP: ' +
              BancodeDados.ClientesCEP.Value;
            RelEtiquetasForm.TempFONE.AsString := 'Fone: ' +
              BancodeDados.ClientesFONE1.Value;
      ...
      begin
        ...
        RelEtiquetasForm.TempNOME.AsString :=
          'SED SOFT ASSESSORIA EM INFORMÁTICA LTDA';
        RelEtiquetasForm.TempEND.AsString := 'Rua Riachuelo, 801 – Liberdade' +
        ...
        RelEtiquetasForm.TempOBS.AsString :=
          'e-mail: comercial@sedsoft.com.br - site: www.sedsoft.com.br';
        RelEtiquetasForm.Temp.Post;
      end;
