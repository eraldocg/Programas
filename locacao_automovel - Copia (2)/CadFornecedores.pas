...
procedure TCadFornecedoresForm.FormClose(Sender: TObject;
...
procedure TCadFornecedoresForm.FormCloseQuery(Sender: TObject;
...
begin
  ...
  begin
    ...
    begin
      qryCPF.Close;
      qryCPF.SQL.Text :=
        'select cnpj, forne_id, nome from fornecedores where cnpj = ' +
        QuotedStr(cpfTmp) + ' and not forne_id = ' +
      ...
      begin
        cpfTmp := '';
        Mensagem('CPF/CNPJ pertencente ao:'#13 + 'Fornecedor: ' +
          FormatFloat('000000', qryCPFFORNE_ID.Value) + '/' + qryCPFNOME.Value,
...
procedure TCadFornecedoresForm.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
  // PrincipalForm.PreencheEnderecosForne;
end;
