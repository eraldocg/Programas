...
begin
  ...
  try
    ...
    if Trim(EditCodigo.Text) <> '' then
      CsClientes.SQL.Add(' and CLI_ID in (' + (EditCodigo.Text) + ')')
    else
      CsClientes.SQL.Add(' and TIPO = ' + QuotedStr('001 - Escola') +
        ' order by nome');
    CsClientes.Open;

    if not CsClientes.IsEmpty then
    begin
      ...
      RelLigacoesForm.lbPeriodo1.Caption := 'Período: ' + Dt_Inicial.DateTimeStr
...
begin
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 1 and (dt_ligar between ' +
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 2 and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryC2.Open;
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 3 and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryC2.Open;
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 4 and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryC2.Open;
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 5 and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryC2.Open;
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 6 and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryC2.Open;
  ...
  qryC2.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and tipo = 7 and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryC2.Open;
  ...
  qryContador.SQL.Text :=
    'select count(ligacao_id) as total from ligacoes where cli_id =' +
    IntToStr(CsClientesCLI_ID.Value) + ' and (dt_ligar between ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Inicial.DateTime)) + ' and ' +
    QuotedStr(FormatDateTime('yyyy/mm/dd', Dt_Final.DateTime) +
    ' 23:59:59') + ')';
  qryContador.Open;
  ...
  if (IndicaLigacoesForm.CsClientesTOTALIZADO.Value > 0) then
    CsClientesFANTASIA2.AsString := CsClientesNOME.Value
  else
    CsClientesFANTASIA2.AsString := '* ' + CsClientesNOME.Value;
