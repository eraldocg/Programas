...
procedure TCadTipoContasForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if BancodeDados.Contas.State in [dsInsert, dsEdit] then
    BancodeDados.Contas.Cancel;
end;

procedure TCadTipoContasForm.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
