  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if not(BancodeDados.QryRetorno.State in [dsEdit]) then
            BancodeDados.QryRetorno.Edit;
          BancodeDados.MarcarAtivo(listaDesfazerRet,
            QryRetornoNUMERO_ARQUIVO.Value, QryRetornoATIVO);
        end;
        QryRetorno.Next;
      end;
    end
...
begin
  ...
  begin
    ...
    begin
      if not(BancodeDados.QryRetorno.State in [dsEdit]) then
        BancodeDados.QryRetorno.Edit;
      BancodeDados.MarcarAtivo(listaDesfazerRet, QryRetornoNUMERO_ARQUIVO.Value,
        QryRetornoATIVO);
    end;
  end;
end;
...
begin
  if (QryRetornoNUMERO_ARQUIVO.Value > 0) then
    BancodeDados.CalcularAtivo(listaDesfazerRet, QryRetornoNUMERO_ARQUIVO.Value,
      QryRetornoATIVO);
