...
begin
  ...
  try
    ...
    relSaldoContasForm.ContasCaixa.SQL.Text := 'select conta_id, conta from tipo_contas where conta_id > 0';
    ...
    if EditConta.Text <> '' then
      relSaldoContasForm.ContasCaixa.SQL.Add(' and conta_id=' + IntToStr(EditConta.KeyValue));
    ...
    begin
      ...
      relSaldoContasForm.lbTotSaldoAnt.Caption:=FormatFloat(',0.00;(,0.00)', totAnt);
      relSaldoContasForm.lbTotSai.Caption:=FormatFloat(',0.00;(,0.00)', totSai);
      relSaldoContasForm.lbTotEnt.Caption:=FormatFloat(',0.00;(,0.00)', totEnt);
      relSaldoContasForm.lbTotSub.Caption:=FormatFloat(',0.00;(,0.00)', totEnt - totSai);
      relSaldoContasForm.lbTotSaldo.Caption:=FormatFloat(',0.00;(,0.00)', totSaldo);

      relSaldoContasForm.lbPeriodo.Caption := 'Período: ' + FormatDateTime('dd/mm/yyyy', dtIni.DateTime) + ' até ' + FormatDateTime('dd/mm/yyyy', dtFim.DateTime);
