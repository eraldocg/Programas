...
procedure TCsVeiculosForm.DBGrid1DrawColumnCell(Sender: TObject;
...
begin
  if not(gdSelected in State) then
    ...
    begin
      ...
      if (BancodeDados.Veiculos.FieldByName('C_S_C_ID').Value > 0) then
      begin
...
procedure TCsVeiculosForm.EditNomeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  ...
  if BancodeDados.VeiculosVEICULO_ID.Value > 0 then
    ...
    begin
      ...
      begin
        ...
        if BancodeDados.VeiculosSIT.Value = 1 then
          BancodeDados.VeiculosSIT.Value := 0
        else
          BancodeDados.VeiculosSIT.Value := 1;
...
begin
  if (BancodeDados.VeiculosSIT.Value) <> 1 then
    Ativo1.Caption := 'Desativar'
  else
    Ativo1.Caption := 'Ativar';
end;
