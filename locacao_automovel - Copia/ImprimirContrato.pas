  ...
  begin
    ...
    try
      ...
      relContratoMatriculaForm.qryV_ClientServ.SQL.Text :=
        'select * from v_client_serv where c_s_c_id = ' +
        IntToStr(BancodeDados.Cont_Serv_ClienC_S_C_ID.Value);
      ...
      begin
        ...
        relContratoMatriculaForm.qryDocumentos.SQL.Text :=
          'select * from documentos where doc_id = ' +
          IntToStr(relContratoMatriculaForm.qryV_ClientServCONTRATO_ID.Value);
        ...
        begin
          ...
          begin
            ...
            relContratoMatriculaForm.DocTempCLI_ID.Value :=
              relContratoMatriculaForm.qryV_ClientServCLI_ID.Value;
            relContratoMatriculaForm.DocTempCONF_ID.Value :=
              relContratoMatriculaForm.qryV_ClientServCONF_ID.Value;
            // BancodeDados.ConfigCONF_ID.Value;
            relContratoMatriculaForm.DocTempTIPO_SERVICO.Value := '';
            relContratoMatriculaForm.DocTempOCULTAR_CAB.Value :=
              relContratoMatriculaForm.qryDocumentosOCULTAR_CAB.Value;
            relContratoMatriculaForm.DocTempCABEC_PRIM_PAG.Value :=
              relContratoMatriculaForm.qryDocumentosCABEC_PRIM_PAG.Value;
            relContratoMatriculaForm.DocTempCABEC_TODAS.Value :=
              relContratoMatriculaForm.qryDocumentosCABEC_TODAS.Value;
            relContratoMatriculaForm.DocTempIMG.Value :=
              relContratoMatriculaForm.qryDocumentosIMG.Value;
            relContratoMatriculaForm.DocTempESP_LINHA.Value :=
              relContratoMatriculaForm.qryDocumentosESP_LINHA.Value;
            relContratoMatriculaForm.DocTempMARGENS.Value :=
              relContratoMatriculaForm.qryDocumentosMARGENS.Value;
            relContratoMatriculaForm.DocTempOCULTAR_CEP.Value :=
              relContratoMatriculaForm.qryDocumentosOCULTAR_CEP.Value;
            relContratoMatriculaForm.DocTempOCULTAR_RESOLUCAO.Value :=
              relContratoMatriculaForm.qryDocumentosOCULTAR_RESOLUCAO.Value;
            relContratoMatriculaForm.DocTempOCULTAR_PARC_ABERTO.Value :=
              relContratoMatriculaForm.qryDocumentosOCULTAR_PARC_ABERTO.Value;
            relContratoMatriculaForm.DocTempFORCAR_RODAPE_IE.Value := 1;
            // relContratoMatriculaForm.qryDocumentosFORCAR_RODAPE_IE.Value;
