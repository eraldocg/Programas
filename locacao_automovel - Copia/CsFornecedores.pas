...
begin
  try
    ...
    BancodeDados.Fornecedores.SQL.Add
      ('select * from fornecedores where forne_id>0');
...
procedure TCsFornecedoresForm.EditNomeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TCsFornecedoresForm.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TCsFornecedoresForm.EditConsultaKeyDown(Sender: TObject;
