...
uses
  ...
  Dialogs, StdCtrls, Buttons, ExtCtrls, DB, ComCtrls, MSHTML_TLB, OleCtrls, SHDocVw, ImgList, Menus, DBClient, Mask, DBCtrls,
...
begin
  ...
  BancodeDados.DocumentosDOC_HTML.Value := (WebBrowser1.Document as IHTMLDocument2).body.innerHTML;
...
procedure TCadDocHTMLForm.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TCadDocHTMLForm.FormKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
