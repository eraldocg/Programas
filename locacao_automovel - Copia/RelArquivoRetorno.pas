...
procedure TRelArquivoRetornoForm.RLBand4BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
  lbTotLiquido1.Caption := FormatFloat(',0.00', (lbTotalDoc1.Value + lbTotalJuros1.Value) - lbTotalAbat1.Value);
end;

procedure TRelArquivoRetornoForm.RLGroup4BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
  ret2_ret_id.Caption := 'Ret.: ' + FormatFloat('000000', RetornoForm.TitQuitado2RET2_RETORNO_ID.Value);
  ret2_n_arq.Caption := 'Nº: ' + IntToStr(RetornoForm.TitQuitado2RET2_NUMERO_ARQUIVO.Value);
  ret2_nosso_n.Caption := 'Nosso número: ' + RetornoForm.TitQuitado2RET2_NOSSO_NUMERO.AsString;
  ret2_dt_recb.Caption := 'Dt. Venc.: ' + RetornoForm.TitQuitado2RET2_DATA_VENCIMENTO.AsString;
  ret2_dt_recb.Caption := 'Dt. Receb.: ' + RetornoForm.TitQuitado2RET2_DATA_RECEBIMENTO.AsString;
  ret2_dt_cred.Caption := 'Dt. Crédito: ' + RetornoForm.TitQuitado2RET2_DATA_CREDITO.AsString;
  ret2_vl_abat.Caption := 'Vl. Abat.: ' + FormatFloat(',0.00', RetornoForm.TitQuitado2RET2_VALOR_ABATIMENTO.Value);
  ret2_vl_mora.Caption := 'Vl. Multa.: ' + FormatFloat(',0.00', RetornoForm.TitQuitado2RET2_VALOR_MORA.Value);
  ret2_vl_doc.Caption := 'Vl. Doc.: ' + FormatFloat(',0.00', RetornoForm.TitQuitado2RET2_VALOR_DOCUMENTO.Value);
  ret2_vl_pago.Caption := 'Vl. Pago: ' + FormatFloat(',0.00', RetornoForm.TitQuitado2RET2_VALOR_PAGO.Value);
  ret2_nome_arq.Caption := 'Nome: ' + RetornoForm.TitQuitado2RET2_NOME_ARQ.AsString;
end;
...
procedure TRelArquivoRetornoForm.RLBand9BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
