...
0 : RLGroup2.DataFields:='EMISSAO';
1 : RLGroup2.DataFields:='VENCIMENTO';
2 : RLGroup2.DataFields:='PAGAMENTO';
end;
end;
...
procedure TRelAnaliticoForm.RLDetailGrid1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
if (BancodeDados.PagarVENCIMENTO.Value<Date) and (BancodeDados.PagarSITUACAO_PAGAR.Value = 'A PAGAR') then
  lbCor.Color:=$00D7D7FF else lbCor.Color:=clWhite;
end;
