...
if (BancodeDados.BoletosVENCIMENTO.Value<Date) and (BancodeDados.BoletosSITUACAO_BOLETO.Value = 'A RECEBER') then begin
  if (BancodeDados.BoletosQtdDias.Value > BancodeDados.BoletosDiasTolCalc.Value) then
  lbCor.Color:=$00D7D7FF else lbCor.Color:=$00C1FFFE;
end;

if BancodeDados.BoletosSITUACAO_BOLETO.Value='CANCELADO' then begin
