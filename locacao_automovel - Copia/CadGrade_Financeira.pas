...
procedure TCadGrade_FinanceiraForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if BancodeDados.GradeFin.State in [dsInsert, dsEdit] then
...
procedure TCadGrade_FinanceiraForm.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
