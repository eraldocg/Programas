...
begin
  ...
  begin
    ...
    Except
      on E: Exception do
      begin
        Mensagem('Ocorreu um erro ao conectar ao banco de dados 2.', mtError,
          [Mbok], mrok, 0);
        Exit;
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        SmsServOBS.Value := 'Agendado via sistema de locação';
        SmsServ.Post;
      end;
...
begin
  lbl_destinatarios.Caption := Format('%0.2d', [FDestinatarios.Count]) +
    ' Destinatários';
end;
